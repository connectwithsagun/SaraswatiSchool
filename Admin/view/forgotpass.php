    ...
    foreach ($falshError as $fe) {
        ...
        <form action="" method="POST">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <input type="email" name="email" class="form-control" id="inputEmail4" required placeholder="Enter Email">
                </div>
                <div class="form-group col-md-4">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-0.1">
                    <input type="submit" class="btn btn-prime btn-lg" value="Reset Password" />
                </div>
